...
namespace SprintManager.Application.Tests.ProjectMemberTests
{
    public class AddProjectMemberHandlerTests
    {
        ...
        public async Task Handle_AddsProjectMember_ReturnsProjectMemberDTO()
        {
            ...
            _mockProjectMemberRepository.Setup(r => r.GetByUserIdAsync(projectMember.UserId, projectMember.ProjectId)).ReturnsAsync((ProjectMember?)null);
            ...
            _mockProjectMemberRepository.Verify(r => r.GetByUserIdAsync(projectMember.UserId, projectMember.ProjectId), Times.Once);
        ...
        public async Task VerifyUserId_ThrowsException_WhenUserIsAlreadyInProject()
        {
            ...
            _mockProjectMemberRepository.Setup(r => r.GetByUserIdAsync(projectMember.UserId, projectMember.ProjectId)).ReturnsAsync(projectMember);
            ...
            // Ensure GetByUserIdAsync was called exactly once.
            _mockProjectMemberRepository.Verify(r => r.GetByUserIdAsync(command.UserId, command.ProjectId), Times.Once);
        }
    }
}